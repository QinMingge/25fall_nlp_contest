...
def recover_cnn_log_summary(checkpoint_dir, output_log_file):
    ...
    print(f"Successfully generated CNN summary log to {output_log_file}")

if __name__ == "__main__":
    checkpoint_dir = "/data/jinda/qinmingge/BERT/25fallnewsclassify/output_ft_cnn"
    output_log_file = "recovered_cnn_training_summary.log"
    recover_cnn_log_summary(checkpoint_dir, output_log_file)
