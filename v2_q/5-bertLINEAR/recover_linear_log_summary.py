...
def recover_linear_log_summary(checkpoint_dir, output_log_file):
    ...
    print(f"Successfully generated Linear summary log to {output_log_file}")

if __name__ == "__main__":
    checkpoint_dir = "/data/jinda/qinmingge/BERT/25fallnewsclassify/output_ft_linear"
    output_log_file = "recovered_linear_training_summary.log"
    recover_linear_log_summary(checkpoint_dir, output_log_file)
